exec.exe: main.o Organism.o Book.o Animation.o Collision.o Entity.o Game.o State.o PlayState.o
	g++ -std=c++11 main.o Book.o Organism.o Collision.o Animation.o Entity.o Game.o State.o PlayState.o -o exec.exe -lsfml-graphics -lsfml-audio -lsfml-window -lsfml-system
